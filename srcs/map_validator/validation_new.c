...
//}
//
//static void		get_z_and_color(t_3d *point, char *str)
//{
//	char	**tmp;
//	int		mas_len;
//
...
//}
//
//static t_3d	**get_map(t_list *list, t_map *map)
//{
//	t_3d	**mas;
//	int		i;
//	int		j;
...
//	if (!(mas = (t_3d**)ft_memalloc(sizeof(t_3d*) * map->rows)))
//		ft_error("Memory allocation error!\n");
//	i = -1;
//	while (++i < map->rows)
//	{
//		if (!(mas[i] = (t_3d*)ft_memalloc(sizeof(t_3d) * map->cols)))
//			ft_error("Memory allocation error!\n");
//		j = -1;
